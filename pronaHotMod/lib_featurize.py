...
def feature_consurf(dict_bval, central_pos, fea_win, norm_raw=True):
	"""
	"""
	#Get the input parts
	raw1 = dict_bval['consurf_score']
	raw2 = dict_bval['consurf_color']
	data = {'consurf_score':raw1,'consurf_color':raw2}
	#The lists that collect the features per position
	window_ = {'consurf_score':[],'consurf_color':[]}
	#The feature names
	featnames_ = {'consurf_score':[],'consurf_color':[]}
